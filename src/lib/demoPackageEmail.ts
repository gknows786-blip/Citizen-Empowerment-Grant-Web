...
export const demoAdminPackageEmail = (user: {
  ...
  html: demoLayout(
    "Package Selection",
    `<h2 style="margin:0 0 16px;color:#1e3a5f">Package Selection Alert</h2><p style="font-size:14px;line-height:1.6">A user selected a package.</p><table style="width:100%;border-collapse:collapse;font-size:14px"><tr><td style="padding:10px;border-bottom:1px solid #e2e8f0;font-weight:700">Name</td><td style="padding:10px;border-bottom:1px solid #e2e8f0">${user.firstName} ${user.lastName}</td></tr><tr><td style="padding:10px;border-bottom:1px solid #e2e8f0;font-weight:700">Email</td><td style="padding:10px;border-bottom:1px solid #e2e8f0">${user.email}</td></tr><tr><td style="padding:10px;border-bottom:1px solid #e2e8f0;font-weight:700">Package</td><td style="padding:10px;border-bottom:1px solid #e2e8f0">${packageName}</td></tr><tr><td style="padding:10px;font-weight:700">Grant Reference</td><td style="padding:10px">${user.refNumber}</td></tr></table><p style="font-size:13px;line-height:1.7;color:#64748b">
  Your reference number is provided for the <strong>${user.packageName}</strong> package settlement.
