...
import {
  ShieldCheck, Phone, Mail, MapPin, Clock, Lock, CheckCircle, Scale,
  Menu, X, LayoutDashboard, Home, FileCheck, FileSpreadsheet, HelpCircle, LogOut,
} from "lucide-react";
      ...
      <footer className="border-t-4 border-blue-950 bg-slate-900 text-white mt-auto">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div><h3 className="font-serif text-base font-bold text-amber-400 mb-3 flex items-center gap-2"><ShieldCheck className="w-5 h-5" /><span>About The Program</span></h3><p className="text-slate-300 text-xs sm:text-sm leading-relaxed">A demonstration portal showing how a citizen grant application experience can be organized for eligible U.S. residents.</p></div>
            <div><h3 className="font-serif text-base font-bold text-amber-400 mb-3">Quick Links</h3><ul className="text-slate-300 text-xs sm:text-sm space-y-2"><li><Link to="/" className="hover:text-amber-300 transition">Home</Link></li><li><Link to="/eligibility" className="hover:text-amber-300 transition">Check Eligibility</Link></li><li><Link to="/apply" search={{ tab: "signup" }} className="hover:text-amber-300 transition">Apply / Sign In</Link></li><li><Link to="/faq" className="hover:text-amber-300 transition">Frequently Asked Questions</Link></li></ul></div>
            <div><h3 className="font-serif text-base font-bold text-amber-400 mb-3">Portal Information</h3><ul className="text-slate-300 text-xs sm:text-sm space-y-2.5"><li className="flex items-center gap-2"><Phone className="w-4 h-4 text-amber-400 shrink-0" /><span>Demonstration contact</span></li><li className="flex items-center gap-2"><Mail className="w-4 h-4 text-amber-400 shrink-0" /><span>Demo support channel</span></li><li className="flex items-center gap-2"><MapPin className="w-4 h-4 text-amber-400 shrink-0" /><span>United States</span></li><li className="flex items-center gap-2"><Clock className="w-4 h-4 text-amber-400 shrink-0" /><span>Information available online</span></li></ul></div>
            <div><h3 className="font-serif text-base font-bold text-amber-400 mb-3">Security</h3><ul className="text-slate-300 text-xs sm:text-sm space-y-2"><li className="flex items-center gap-2"><Lock className="w-4 h-4 text-emerald-400 shrink-0" /><span>Secure form experience</span></li><li className="flex items-center gap-2"><CheckCircle className="w-4 h-4 text-emerald-400 shrink-0" /><span>Input validation</span></li><li className="flex items-center gap-2"><ShieldCheck className="w-4 h-4 text-emerald-400 shrink-0" /><span>Privacy-conscious design</span></li><li className="flex items-center gap-2"><Scale className="w-4 h-4 text-emerald-400 shrink-0" /><span>Accessibility-focused UI</span></li></ul></div>
          </div>
          <hr className="border-slate-800 mb-6" />
          <div className="text-center text-slate-400 text-xs"><p className="mb-2">&copy; {new Date().getFullYear()} U.S. Citizen Grant Portal Demonstration. All rights reserved.</p><p className="text-slate-400 text-[11px]">Independent demonstration project &bull; Not an official U.S. government website</p></div>
        </div>
      </footer>
    </div>
  );
